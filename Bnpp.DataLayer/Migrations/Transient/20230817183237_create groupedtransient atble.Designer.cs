...
namespace Bnpp.DataLayer.Migrations.Transient
{
    ...
    [Migration("20230817183237_create groupedtransient atble")]
    partial class creategroupedtransientatble
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bnpp.DataLayer.Entities.GroupedTransients", b =>
                {
                    ...
                    b.Property<DateTime>("CrerateDate")
            ...
            modelBuilder.Entity("Bnpp.DataLayer.Entities.Transients", b =>
                {
                    ...
                    b.Property<string>("TransientTime")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Bnpp.DataLayer.Entities.TransientDocuments", b =>
                {
                    b.HasOne("Bnpp.DataLayer.Entities.Transients", "Transients")
                        .WithMany("TransientDocuments")
                        .HasForeignKey("TransientsId")
